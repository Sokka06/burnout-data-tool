...
3. Export the VDB binary file to YAML in raw format with `bdtool.exe vdb export "path/to/car_vdb.bin" "path/to/car_vdb.yaml"`, or to a more readable format with `bdtool.exe vdb export "path/to/car_vdb.bin" "path/to/car_vdb.yaml" --format dto --definitions "path/to/bo4_vdb_definitions.yaml"`.
